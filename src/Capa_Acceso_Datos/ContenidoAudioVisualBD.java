...
public class ContenidoAudioVisualBD {
    private final String RUTA_ARCHIVO = System.getProperty("user.dir").replace("\\dist","") +
                                                                         "\\src\\Archivo\\ContenidoAudioVisualBD.txt";
    
   //private final String RUTA_ARCHIVO = "ContenidoAudioVisualBD.txt";
