...
public abstract class Usuario implements Serializable{
    ...
    public String reporteDescargaAdmin(){
        ...
        hilera.append( "\n"+Validacion.numerosLetras((int) totalPagadoDolares) +" DOLARES, CON "
                +Validacion.numerosLetras(decDolares)+" CENTAVOS\n");
        
        hilera.append("\nTotal pagado en colones: ").append("₡"+formatoDinero.format(totalPagadoColones));
        hilera.append( "\n"+Validacion.numerosLetras((int)totalPagadoColones) +" COLONES, CON "
                +Validacion.numerosLetras(decColones)+" CENTAVOS\n");
    ...
    public String reporteDescargaCompra(Usuario_Perfil perfilp){
        ...
        hilera.append( "\n"+Validacion.numerosLetras((int) totalPagadoDolares) +" DOLARES ");
        hilera.append("\nTotal pagado en colones: ").append("₡"+totalPagadoColones);
        hilera.append( "\n"+Validacion.numerosLetras((int)totalPagadoColones) +" COLONES ");
